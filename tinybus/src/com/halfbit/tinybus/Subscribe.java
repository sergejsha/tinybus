 ...
 * <p>If this annotation is applied to methods with zero parameters 
 * or more than one parameter, the object containing the method will
 * not be able to register for event delivery from the {@link Bus}.
